...
按视口宽度/是否竖屏选择一组参数（与参考站同思路）：

| 断点 | fov | cameraZ | radius | panelW×H | rowSpacing |
|------|-----|---------|--------|----------|------------|
| 桌面默认 | 50 | 13 | 7.8 | 1.54×2.09 | 7 |
| 平板 / 窄屏 | 60–70 | 7.5–11 | 4.5–6.5 | 更小 | 3.8–6.5 |

`radius` 决定圆柱半径；`rowSpacing` 决定相邻圈的垂直间距；面板尺寸略放大（`PANEL_SCALE = 1.1`）避免缝隙过大。
